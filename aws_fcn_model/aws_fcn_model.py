...
INITIAL_LEARNING_RATE = 4*10e-6       # Initial learning rate.
...
def inputs(train=True,inpt_dir=None):
    if not FLAGS.data_dir:
          raise ValueError('Please supply a data_dir')
    data_dir = FLAGS.data_dir
    if inpt_dir is not None:
       data_dir=inpt_dir
    return aws_fcn_input.inputs(data_dir=data_dir, train = train,
...
def inference(inputs,train=True,random_fc8=True):
  """Build our FCN model.
